...
export function HeroBanner() {
  return (
    <div className="relative h-40 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-purple-600/80 via-blue-600/80 to-cyan-500/80 animate-gradient-x"></div>
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-8 right-8 w-10 h-10 border-2 border-purple-300/40 rounded-full animate-spin-slow"></div>
      </div>
